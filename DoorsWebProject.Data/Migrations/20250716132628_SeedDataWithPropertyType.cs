...
{
    /// <inheritdoc />
    public partial class SeedDataWithPropertyType : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("33333333-cccc-4ddd-aaaa-000000000001"), "High-quality steel door with modern design.", 200.0m, "https://starkdoor.com/external/public_html/images/categories/stark-premium-steel-doors.webp", "Steel", "S100", 499.99m, 4.5m, "Entry Door", 90.0m },
                    ...
                    { new Guid("33333333-cccc-4ddd-aaaa-000000000004"), "Fireproof steel door suitable for safety exits.", 210.0m, "https://5.imimg.com/data5/EM/DU/NC/SELLER-8174112/man-door-500x500.png", "Steel with Fireproof Coating", "F400", 749.99m, 5.0m, "Fire Door", 90.0m },
                    { new Guid("33333333-cccc-4ddd-aaaa-000000000005"), "Lightweight aluminum door with modern aesthetics.", 220.0m, "https://www.glenviewdoors.com/ExteriorAluminum/gallery/Swing-Aluminum-Exterior-Door-with-Sidelites-EAL-SWS-W6-2SL.jpg", "Aluminum", "E500", 599.00m, 3.8m, "Exterior Door", 100.0m }
                });
        }
