namespace DoorsWebProject.Data.Seeding
{
	...
	public class IdentitySeeder : IIdentitySeeder
	{
			...
			, IConfiguration configuration)
		{
			...
			this.userEmailStore = this.GetEmailStore();
		}
		...
		private async Task SeedUsersAsync()
		{
			...
			if (testUserSeeded == null)
			{
				...
				await this.userEmailStore.SetEmailAsync(testUser, testUserEmail, CancellationToken.None);
			...
			if (adminUserSeeded == null)
			{
				...
				await this.userEmailStore.SetEmailAsync(adminUser, adminUserEmail, CancellationToken.None);
